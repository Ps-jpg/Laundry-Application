...
public class PaymentActivity extends Activity implements PaymentResultWithDataListener, ExternalWalletListener {
    ...
    public void startPayment() {
        ...
        etApiKey.setText ("rzp_test_D2BnZqX13PP5UK");
    ...
    public void onPaymentSuccess(String s, PaymentData paymentData) {
        try {
            ...
            // Start PaymentAnimation activity after successful payment
            Intent intent = new Intent(PaymentActivity.this, PaymentAnimation.class);
