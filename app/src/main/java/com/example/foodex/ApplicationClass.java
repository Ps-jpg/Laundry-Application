...
public class ApplicationClass extends Application {
    ...
    private String globalWorkType;  // Single value for all items
    private String defaultUsername = "admin"; // Default username
    @Override
    public void onCreate() {
        super.onCreate();
        globalWorkType = "Nothing";  // Set your global work type here
